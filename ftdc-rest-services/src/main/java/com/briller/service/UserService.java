...
public class UserService {
    ...
    public String processForgotPassword(String userName) {
        ...
        LOGGER.info("successFull check of user present in same name and otp generation and sending mail"+userName);

        }
        catch(Exception e)
        {
            LOGGER.error("error in checking user already exists"+e.getMessage());
            throw e;
        }
    ...
    public Boolean resetPassword(Users user) {
        ...
        LOGGER.info("SuccessFull execution of reset password and reset mail"+user.getUserName());
        return true;
        }
        catch(Exception e) {
