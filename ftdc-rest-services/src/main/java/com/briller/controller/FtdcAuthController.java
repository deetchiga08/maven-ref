...
public class FtdcAuthController {
    ...
    public ResponseEntity<?> forgotPassword(@RequestBody Users user) {
        String responseMsg = userService.processForgotPassword(user.getUserName());
        return new ResponseEntity<>(new ftdcResponse(responseMsg), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> resetPassword(@RequestBody Users user) {
        ...
        if (resetSuccess) {
            return new ResponseEntity<>(new ftdcResponse(MessageUtility.getMessage("resetSuccess")), HttpStatus.OK);
        } else {
            return new ResponseEntity<>(new ftdcResponse(MessageUtility.getMessage("resetFail")), HttpStatus.OK);
        }
    }
